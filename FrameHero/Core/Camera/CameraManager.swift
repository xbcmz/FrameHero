...
final class CameraManager: NSObject, ObservableObject {
    ...
    let sessionQueue: DispatchQueue = DispatchQueue(label: "framehero.camera.session")
    /// 处理视频帧输出的队列。
    let videoOutputQueue: DispatchQueue = DispatchQueue(label: "framehero.camera.videoOutput")
